...
public class TextUtils {
    ...
    public static void addFoodEffectTooltipWithDetail(ItemStack itemIn, List<Component> lores, float durationFactor) {
        addFoodEffectTooltipWithDetail(itemIn, lores, durationFactor, true);
    }
     ...
     */
    public static void addFoodEffectTooltipWithDetail(ItemStack itemIn, List<Component> lores, float durationFactor, boolean detail) {
        ...
        if (effectList.isEmpty()) {
            ...
            for (Pair<MobEffectInstance, Float> effectPair : effectList) {
                ...
                int effectChance = (int) (100 * effectPair.getSecond());
